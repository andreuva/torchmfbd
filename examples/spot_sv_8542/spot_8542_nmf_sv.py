...
if __name__ == '__main__':
    ...
    for i in range(2):
        ax[0, i].imshow(frames[0, i, 0, :, :], cmap='viridis', interpolation='nearest')
        ax[1, i].imshow(obj[i][0, :, :], cmap='viridis', interpolation='nearest')
    pl.savefig('nmf_sv.png', dpi=300, bbox_inches='tight')
