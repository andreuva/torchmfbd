...
if __name__ == '__main__':
    ...
    lam = 6 # +65 mA
    npix = 512
    obs_file = f"../../reproducibility/obs/spot_20200727_083509_8542_npix512_original.h5"
    ...
    mfbd = [None] * 2
    mfbd[0] = fits.open('../../reproducibility/aux/camXX_2020-07-27T08:35:09_00000_8542_8542_+65_lc0.fits')[0].data[None, :, ::-1]
    mfbd[1] = fits.open('../../reproducibility/aux/camXXV_2020-07-27T08:35:09_00000_8542_8542_+65_lc0.fits')[0].data[None, :, ::-1]
